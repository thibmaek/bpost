...
var composedFetch = (function (itemIdentifier) {
...
var getStatus = (function (id) {
  return composedFetch(id).then(function (data) {
    return console.log(find(data.processOverview.processSteps, { status: 'active' }));
  }).catch(function (e) {
    return console.log(e);
  });
});

var droppedOffBySender = function droppedOffBySender(id) {
  return composedFetch(id).then(function (data) {
    return console.log(find(data.events, { key: 'received.domestic-corner' }));
  }).catch(function (e) {
    return console.log(e);
  });
};

var availableForPickup = function availableForPickup(id) {
  composedFetch(id).then(function (data) {
    return find(data.processOverview.processSteps, { knownProcessStep: 'AVAILABLE_IN_POST_POINT_INTERNATIONAL' });
  }).then(function (obj) {
...
var getPackageWeight = function getPackageWeight(id) {
  composedFetch(id).then(function (data) {
    return data.weightInGrams;
  }).catch(function (e) {
    return console.error(e);
  });
};

var identifier = function identifier(id) {
  composedFetch(id).then(function (data) {
    return data.key.id;
  }).catch(function (e) {
    return console.error(e);
...
var deliveryMethod = function deliveryMethod(id) {
  return composedFetch(id).then(function (data) {
    return data.requestedDeliveryMethod.toLowerCase().split('_');
  }).catch(function (e) {
    return console.error(e);
  });
};

var sourcePostalPoint = function sourcePostalPoint(id) {
  composedFetch(id).then(function (data) {
    var result = find(data.events, { key: 'received.domestic-corner' });
...
var destinationPostalPoint = function destinationPostalPoint(id) {
  composedFetch(id).then(function (data) {
    return data.deliveryPoint.name.en;
  }).catch(function (e) {
    return console.error(e);
  });
};

var destinationAsAddress = function destinationAsAddress(id) {
  composedFetch(id).then(function (data) {
    var obj = data.deliveryPoint;
...
var openingHours = function openingHours(id, day) {
  if (!day) throw new Error('Please specify a day');

  composedFetch(id).then(function (data) {
    var obj = find(data.deliveryPoint.openingSchedules, { dayOfTheWeek: day.toUpperCase() });
...
var coordinate = function coordinate(id) {
  return composedFetch(id).then(function (data) {
    return {
...
var index = {
  ...
  droppedOffBySender: droppedOffBySender,
  ...
  sourcePostalPoint: sourcePostalPoint,
  destinationPostalPoint: destinationPostalPoint,
  destinationAsAddress: destinationAsAddress,
