...
//     expect(request).toEqual(`Pathoekeweg 73, 8000 Brugge`);
//     done();
//   });
// });
...
//     const request = await bpost.openingHours(global.BPOST_ID);
//     expect(request).toThrowError(`Please specify a day`);
//     done();
//   });
//
//   it(`should return the opening hours`, async done => {
//     const request = await bpost.openingHours(global.BPOST_ID, `monday`);
//     expect(request).toEqual({ open: `07:00`, close: `19:00` });
//     done();
//   });
// });
